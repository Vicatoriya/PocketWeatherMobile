...
const WeatherMap = () => {
    ...
    const airQuality: AirQualityData | null = data;
                  ...
                  <View style={styles.additionalInfo}>
                      ...
                      {settings.ecoMode && (
                          <View style={styles.ecoModeMessage}>
                              <Text style={styles.ecoModeText}>Включен режим "Экология"</Text>
                          </View>
                      )}
  
                      {settings.ecoMode && (
                          <View style={styles.airQualitySection}>
                              <Text style={styles.sectionTitle}>Качество воздуха:</Text>
                              {airQuality ? (
                                  <>
                                      <View style={styles.parameterItem}>
                                          <Text style={styles.parameterName}>{parameterNames.aqi}</Text>
                                          <Text style={styles.parameterValue}>{airQuality.aqi}</Text>
                                      </View>
                                      <View style={styles.divider} />
                                      {airQuality.iaqi?.pm25?.v && (
                                          <View style={styles.parameterItem}>
                                              <Text style={styles.parameterName}>{parameterNames.pm25}</Text>
                                              <Text style={styles.parameterValue}>{airQuality.iaqi.pm25.v} µg/m³</Text>
                                          </View>
                                      )}
                                      <View style={styles.divider} />
                                      {airQuality.iaqi?.pm10?.v && (
                                          <View style={styles.parameterItem}>
                                              <Text style={styles.parameterName}>{parameterNames.pm10}</Text>
                                              <Text style={styles.parameterValue}>{airQuality.iaqi.pm10.v} µg/m³</Text>
                                          </View>
                                      )}
                                      <View style={styles.divider} />
                                      {airQuality.iaqi?.co?.v && (
                                          <View style={styles.parameterItem}>
                                              <Text style={styles.parameterName}>{parameterNames.co}</Text>
                                              <Text style={styles.parameterValue}>{airQuality.iaqi.co.v} ppm</Text>
                                          </View>
                                      )}
                                      <View style={styles.divider} />
                                      {airQuality.iaqi?.no2?.v && (
                                          <View style={styles.parameterItem}>
                                              <Text style={styles.parameterName}>{parameterNames.no2}</Text>
                                              <Text style={styles.parameterValue}>{airQuality.iaqi.no2.v} µg/m³</Text>
                                          </View>
                                      )}
                                      <View style={styles.divider} />
                                      {airQuality.iaqi?.so2?.v && (
                                          <View style={styles.parameterItem}>
                                              <Text style={styles.parameterName}>{parameterNames.so2}</Text>
                                              <Text style={styles.parameterValue}>{airQuality.iaqi.so2.v} µg/m³</Text>
                                          </View>
                                      )}
                                      <View style={styles.divider} />
                                      {airQuality.iaqi?.o3?.v && (
                                          <View style={styles.parameterItem}>
                                              <Text style={styles.parameterName}>{parameterNames.o3}</Text>
                                              <Text style={styles.parameterValue}>{airQuality.iaqi.o3.v} µg/m³</Text>
                                          </View>
                                      )}
                                      <View style={styles.divider} />
                                  </>
                              ) : (
                                  <Text>Нет данных о качестве воздуха.</Text>
                              )}
                          </View>
                      )}
                  </View>
