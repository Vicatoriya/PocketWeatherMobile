...
type WeatherMarker = {
  ...
  const WeatherMap = () => {
    ...
    const coordsString = selectedMarker ? `${selectedMarker.coordinates.latitude},${selectedMarker.coordinates.longitude}` : "";
          ...
          >
            <View style={styles.rowContainer}>
              <Text style={styles.coordsText}>
                [{selectedMarker.coordinates.latitude.toFixed(4)}, {selectedMarker.coordinates.longitude.toFixed(4)}]
              </Text>
              <TouchableOpacity
